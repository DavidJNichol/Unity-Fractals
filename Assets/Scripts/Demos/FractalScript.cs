...
class FractalScript : MonoBehaviour
{
	...
	public void Initialize(FractalScript parent, int childIndex)
	{
	...
	private IEnumerator CreateChildren()
	{
		for (int i = 0; i < childDirections.Length; i++)
		{
			if (Random.value < spawnProbability)
			{
				...
				new GameObject("Fractal Child").AddComponent<FractalScript>().Initialize(this, i);
			}
		}
	}	
